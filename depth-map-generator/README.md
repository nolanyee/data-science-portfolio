...
<img src="images/normalmap1.jpg" width ="400">

### Displacement Map Generation
The values of the normal map are used to calculate an x and y displacement map. The x component is calculated as -*n<sub>x</sub>/n<sub>z</sub>* and the y component as -*n<sub>y</sub>/n<sub>z</sub>*.

<img src="images/DepthMapFig21.png" width ="400">
