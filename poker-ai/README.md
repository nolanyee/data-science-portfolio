...
__Flush__\
For each suit and each value (excluding 2-5, since they cannot be the high card of a flush) the number *n* of cards of the same suit below the high card value is calcualted, then the combinations are C<sup>*n*</sup><sub>4</sub>
